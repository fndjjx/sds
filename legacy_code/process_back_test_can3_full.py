...
#
        ...
        max_index = list(argrelextrema(np.array(ma5),np.greater)[0])
        print " max index %s"%max_index
        min_index = list(argrelextrema(np.array(ma5),np.less)[0])
...
#
        ...
        print " min index %s"%min_index
        com_de=1
        if max_index[-1]>min_index[-1] and max_index[-1]>=495:
            com_de=1
#######
