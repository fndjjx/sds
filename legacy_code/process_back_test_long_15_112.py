...
#######
        ...
        deltama10 = self.ma(self.close_price, 10, 0, current_price_index)-self.ma(self.close_price, 10, -1, current_price_index)
        deltama100 = self.ma(self.close_price, 100, 0, current_price_index)-self.ma(self.close_price, 100, -1, current_price_index)
...
######
        ...
        ma_list=[deltama20,deltama30,deltama60,deltama100]
        mac=0
        for i in ma_list:
            if i>0:
                mac+=1
