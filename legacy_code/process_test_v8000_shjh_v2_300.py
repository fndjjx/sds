...
###########################
        ...
        imf_large_ma5 = self.ma(imf_list[3], 1, 0, 299)
        imf_large_ma5_before = self.ma(imf_list[3], 1, -1, 299)
        ...
        price_list = self.close_price[current_price_index-299:current_price_index+1]
        ...
        if len(list(price_max_index)) > 0 and len(list(price_min_index)) > 0 :
            ...
            if tmp[-1]<490 and tmp[-1]>=485:
                ...
                for i in range(1,len(index_list)-1):
                    ...
                    distance =  299 - last_extrem_position
                    true_index = 299-distance
            ...
            distance_last_imf_max = 299-list(imf_max_true_index)[-1]
            distance_last_imf_min = 299-list(imf_min_true_index)[-1]
...
#            min_diff = abs(after_re[-1]-after_re[vol_min_index[-1]])
            ...
            if 1:#self.buy_price == 0:# and abs(self.last_true_max-imf_max_true_index[-1])<10 and abs(self.last_true_min-imf_min_true_index[-1])<10:#(buyhigh/buyhigh2)>0.3 and (buyhigh/buyhigh2)<3:
                ...
                if imf_max_true_index[-1]<imf_min_true_index[-1]:# and 299-imf_min_true_index[-1]>(mean_min_max):# and imf_min_true_index[-1]>465:# and 299-imf_max_true_index[-1]<(mean_min_max+mean_max_min):# and (299-imf_min_true_index[-1])>(mean_max_min+std_max_min)) :
                   ...
                   #     data = [rawdata[i+1]-rawdata[i] for i in range(len(rawdata)-1)]
                    ...
                    if small_imf_max_index[-1]<small_imf_min_index[-1]:#len(small_index_max)>0 and  ((price_max_data[-1]-price_max_data[small_index_max[-1]-imf_min_true_index[-1]])/price_max_data[small_index_max[-1]-imf_min_true_index[-1]])>-0.02 :
                        ...
                        small_index_max.append(299)
                    else:
                        small_index_min.append(299)
                  ...
                  #          min_index.append(sum(small_index_min)/len(small_index_min))
                    ...
                    if tmp!=[] and max_index != []:
                        if (tmp[0] in max_index) and  299-max_index[-1]>mean_max_min-1 and 299-max_index[-1]<mean_max_min+2:#+2*std_max_min:# and len(data)-max_index[-1]<mean_max_min+2*std_max_min:
                            imf_extrem_decision6 = -1
                        if (tmp[-1] in min_index) and 299-min_index[-1]>(mean_min_max)-std_min_max and 299-min_index[-1]<(mean_min_max)+std_min_max:#std_max_min and len(data)-max_index[-1]<dis+std_max_min:#+2*std_max_min:# and len(data)-max_index[-1]<mean_max_min+2*std_max_min:
                            imf_extrem_decision6 = 1
                        if (tmp[-1] in max_index) and tmp[-1]>497:# and 299-min_index[-1]<(mean_min_max)+std_min_max:#std_max_min and len(data)-max_index[-1]<dis+std_max_min:#+2*std_max_min:# and len(data)-max_index[-1]<mean_max_min+2*std_max_min:
                            imf_extrem_decision6 = 1
                    if tmp!=[] and min_index != []:
                        ...
                        if (tmp[-1] in min_index) and 299-min_index[-1]>(mean_min_max)-std_min_max and 299-min_index[-1]<(mean_min_max)+std_min_max:
                            imf_extrem_decision6 = 1
...
#                        imf_extrem_decision6 = 0
             ...
             #           current_min = (299 - estimate_min)
             #           if current_min<3:
             #               imf_extrem_decision = -1
             #       
             #       elif current_max>(mean_max_min-3) and current_max<(mean_max_min+3):#-std_max_min :
             #           imf_extrem_decision = -1
                elif imf_max_true_index[-1]<imf_min_true_index[-1] and (299-imf_min_true_index[-1])<3 :
            #            imf_extrem_decision = -1
                    print "pp %s"%(buyhigh/buyhigh2)
                    imf_extrem_decision = -1
                elif imf_max_true_index[-1]>imf_min_true_index[-1] :#and 299-imf_max_true_index[-1]>mean_max_min :#and imf_max_true_index[-1]>465:#and (((299-imf_max_true_index[-1])>(mean_max_min+std_max_min) and (299-imf_max_true_index[-1])>(mean_min_max+std_min_max)) or ((299-imf_max_true_index[-1])<(mean_max_min+3) and (299-imf_max_true_index[-1])>(mean_max_min-3) and len(imf_min_remove_index)>0)):
             ...
             #           residual = price_min_data
                  ...
                  #          max_index.append(sum(small_index_max)/len(small_index_max))
                    ...
                    if max_index != []:
                        ...
                        if (tmp[-1] in max_index) and 299-max_index[-1]>(mean_max_min)-1.5 and 299-max_index[-1]<mean_max_min+2 :#+2*std_max_min :#and len(data)-max_index[-1]<mean_max_min+2*std_max_min:
                            imf_extrem_decision6 = -1
                        if (tmp[-1] in max_index) and tmp[-1]>497:#max_index[-1]>(mean_max_min)-1.5 and 299-max_index[-1]<mean_max_min+2 :#+2*std_max_min :#and len(data)-max_index[-1]<mean_max_min+2*std_max_min:
                            imf_extrem_decision6 = 1
                    if min_index != []:
                        #if (tmp[0] in min_index) and  tmp[0]>4 and (tmp[-1] in min_index) and len(data)-min_index[-1]<6:
                        print len(data)-min_index[-1]
                        if (tmp[-1] in min_index) and 299-min_index[-1]<3:# and self.last_min_index == [] and self.last_max_index==[] and min_index!=[]:
                            imf_extrem_decision6 = -1
                    if min_index != []:
                        #if (tmp[0] in max_index) and tmp[0]>4 and (tmp[-1] in min_index)  and len(data)-min_index[-1]<6:
                        print len(data)-min_index[-1]
            ...
            if 0:#self.buy_price != 0 :#and abs(self.last_true_max-imf_max_true_index[-1])<10 and abs(self.last_true_min-imf_min_true_index[-1])<10:
                ...
                if imf_min_true_index[-1]<imf_max_true_index[-1] and imf_max_true_index[-1]<485:
                    ...
                    current_last_min = 299 - math.ceil(estimate_min)
                    ...
                    current_last_min = 299 - imf_min_true_index[-1]
                    print "current_last_min %s"%current_last_min
                    print "potion %s"%(abs(last_max_min-current_last_min)/float(last_max_min))
                    imf_extrem_decision = 1
                elif imf_min_true_index[-1]>imf_max_true_index[-1] and imf_min_true_index[-1]<490:
...
#            once_flag = 1
  ...
  #          self.holdtime = 0
  #          once_flag = 1
        elif   self.buy_price==0 and   imf_extrem_decision6==-1  :#and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]<self.macd[current_price_index-3]<self.macd[current_price_index-4]<self.macd[current_price_index-5] :#and small_imf_decision1 == -1:#imf_extrem_decision8 == 1 and buy_decision2 == -1:# and  self.close_price[current_price_index-1]<self.close_price[current_price_index]:# and imf_below_0_decision == -1:# and imf_power_decision == -1:
...
if __name__ == "__main__":
    ...
    generate_emd_func = generateEMDdata(datafile,begin,300)
