...
###
        ...
        #    imf2_or_flag=1
        if (imf2_min_index[-1]<imf2_max_index[-1] and imf2_max_index[-1]>=995) or (imf2_min_index[-1]>imf2_max_index[-1] and imf2_min_index[-1]<=993) :#and imf2_max_index[-1]-imf2_min_index[-1]>3:
            imf2_or_flag=2
...
########
        ...
        boll_low2 = 1*(-np.std(self.close_price[current_price_index-period1:current_price_index+1]))+np.mean(self.close_price[current_price_index-period1:current_price_index+1])
        ...
        #    boll_de=2
        if current_price<boll_low1 and current_price<boll_low2 :
            boll_de=1
        ...
        macd_de=1
        if self.macd[current_price_index]<self.macd[current_price_index-1]<0:# and self.macd[current_price_index]<0:
            macd_de=0
