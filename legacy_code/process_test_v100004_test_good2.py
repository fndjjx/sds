...
##############################################################
     ...
     #       small_imf_max_true_index = small_imf_max_index
        ...
        if small_imf_min_true_index[-1]>=497 and small_imf_min_true_index[-1]>small_imf_max_true_index[-1] :#and self.imf1_last_last=="max":
            imf1_flag=1
        if small_imf_max_true_index[-1]>=497 and small_imf_max_true_index[-1]>small_imf_min_true_index[-1] :#and self.imf1_last_last=="min":
            imf1_flag=2
...
##############
                    ...
                    if   (imf_min_true_index[-1]>496 or (self.last_last=="max" and imf1_flag==1))  :#and abs(((self.core+self.core2)/2.0)-current_core)>3 :#and abs(self.core-self.core3)<=2 and abs(self.core-self.core2)<=2:#est_per%2==0 and (yu<0.3 or yu>0.7):
                        down_test_decision1=-1
