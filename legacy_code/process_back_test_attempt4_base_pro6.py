...
##
        ...
        mpp,mpm,mps=montecarlo_simulate(mp_list[current_price_index-20:current_price_index+1],10)
        p,m,s=montecarlo_simulate(ma5[current_price_index-20:current_price_index+1],1000)
...
##
        ...
        datav = self.vol[current_price_index-p:current_price_index+1]
        dataj = self.je[current_price_index-p:current_price_index+1]
        if calc_recentdown_pro(datac,dataj,datav,1)<0.5 or calc_recentdown_pro(datac,dataj,datav,3)<0.5 or calc_recentdown_pro(datac,dataj,datav,3)<0.5:
            rdde=1
...
###
        ...
        sel = 1
        if sel==1:
            if  diffmp[-1]<0 and mean_de==1 and   len(self.mclist2)>0 and self.mclist2[-1]>0 :#and (( self.fail_flag==0) or (self.fail_flag==1 and rdde==1)):
                jede=1
     ...
     #           jede=2
        ...
        obs=self.close_price[current_price_index-9:current_price_index+1]
        #obs=mp_list[current_price_index-9:current_price_index+1]
