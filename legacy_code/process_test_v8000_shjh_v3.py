...
##############################################################
       ...
       # elif self.buy_price!=0 or (self.buy_price==0 and coef_list2[2]<0.85 and  coef_list1[1]>0 and coef_list1[1]>coef_list1[0] and coef_list1[1]>coef_list1[2]):#and coef_list1[2]>0:
        ...
        coef_decision1=1
        if coef_list1[1]<0 or coef_list2[2]<0 :
            coef_decision1=0
...
##########
        ...
        if len(price_wrong1)>=2 or len(price_wrong2)>0:
...
############
        ...
        ma_decision1=1
        if self.ma_count1<0 and self.ma_count<0 and self.ma_count1<self.ma_count:
            ma_decision1=0
