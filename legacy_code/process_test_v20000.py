...
#                count = 10
   ...
   #         return -1
    ...
    def judge_in_list(self,point,index_list):
        tmp = [point-1,point,point+1]
        for i in tmp:
            for j in index_list:
                 if i==j:
                     return True
    ...
    def remove_point(self,imf_list,current_price_index):
        ...
        imf_max_index = filter(lambda x:x<495,imf_max_index)
        imf_min_index = filter(lambda x:x<495,imf_min_index)
        ...
        for i in range(2):
            ...
            imf_seq = imf2[start:end+1]
            price_seq = price_list[start:end+1]
            print "start %s end %s "%(start,end)
            print "imf seq %s"%imf_seq
            print "price seq %s"%price_seq
            print "%s seq coef%s"%(i,np.corrcoef(price_seq,imf_seq)[0][1])
            if np.corrcoef(price_seq,imf_seq)[0][1]>0.75:
                trust_position = end
                choice = i
                break
        ...
        imf_max_true_index = filter(lambda x:x<=trust_position,imf_max_index)
        imf_max_remove_index = filter(lambda x:x>trust_position,imf_max_index)
        imf_min_true_index = filter(lambda x:x<=trust_position,imf_min_index)
        imf_min_remove_index = filter(lambda x:x>trust_position,imf_min_index)

        print "coef imf max true index%s"%imf_max_true_index
        print "coef imf max remove index%s"%imf_max_remove_index
        print "coef imf min true index%s"%imf_min_true_index
        print "coef imf min remove index%s"%imf_min_remove_index


        return (imf_choice,imf_max_true_index,imf_max_remove_index,imf_min_true_index,imf_min_remove_index)
...
##############################################################
   ...
   #         coef_choice=3
        ...
        print "\n"
        residual_data = np.array(list(imf_list[-2]))
        residual_max_index = list(argrelextrema(residual_data,np.greater)[0])
        print " residual max index %s"%residual_max_index
        residual_min_index = list(argrelextrema(residual_data,np.less)[0])
        print " residual min index %s"%residual_min_index
        print "\n"
        print "\n"
...
#################
            ...
            if coef_choice==2:
                if imf_max_index[-1]>imf_min_index[-1] and imf_max_index[-1]>=495:
                    ...
                    imf_max_remove_index = list(filter(lambda n:n>=imf_min_index[-1],imf_max_index))
                    imf_min_true_index = list(filter(lambda n:n<imf_min_index[-1],imf_min_index))
                    imf_min_remove_index = list(filter(lambda n:n>=imf_min_index[-1],imf_min_index))
                elif imf_max_index[-1]<imf_min_index[-1] and imf_min_index[-1]<495:
                    imf_max_true_index = imf_max_index
                    imf_max_remove_index = []
                    imf_min_true_index = imf_min_index
         ...
         #   imf_min_remove_index = list(filter(lambda n:n>=495,imf_min_index))
            ...
            (imf_choice,imf_max_true_index,imf_max_remove_index,imf_min_true_index,imf_min_remove_index)=self.remove_point(imf_list,current_price_index)




            if imf_max_index[-1]>imf_min_index[-1] and imf_max_index[-1]>=493:
                imf_max_true_index = list(filter(lambda n:n<imf_max_index[-1],imf_max_index))
                imf_max_remove_index = list(filter(lambda n:n>=imf_max_index[-1],imf_max_index))
                imf_min_true_index = list(filter(lambda n:n<imf_max_index[-1],imf_min_index))
                imf_min_remove_index = list(filter(lambda n:n>=imf_max_index[-1],imf_min_index))
            elif imf_max_index[-1]>imf_min_index[-1] and imf_max_index[-1]<493:
                imf_max_true_index = imf_max_index
                imf_max_remove_index = []
                imf_min_true_index = imf_min_index
                imf_min_remove_index = []
            elif imf_max_index[-1]<imf_min_index[-1] and imf_min_index[-1]>=493:
                imf_max_true_index = list(filter(lambda n:n<imf_min_index[-1],imf_max_index))
                imf_max_remove_index = list(filter(lambda n:n>=imf_min_index[-1],imf_max_index))
                imf_min_true_index = list(filter(lambda n:n<imf_min_index[-1],imf_min_index))
                imf_min_remove_index = list(filter(lambda n:n>=imf_min_index[-1],imf_min_index))
                ...
                imf_min_true_index = imf_min_index
                imf_min_remove_index = []
            if imf_max_true_index!=[] and imf_min_true_index!=[]:
            ...
            if 1:#imf_choice>0:#self.buy_price == 0:# and abs(self.last_true_max-imf_max_true_index[-1])<10 and abs(self.last_true_min-imf_min_true_index[-1])<10:#(buyhigh/buyhigh2)>0.3 and (buyhigh/buyhigh2)<3:
                print "prepare buy"
                ...
                if imf_max_true_index[-1]<imf_min_true_index[-1]:# and 499-imf_min_true_index[-1]>(mean_min_max):# and imf_min_true_index[-1]>465:# and 499-imf_max_true_index[-1]<(mean_min_max+mean_max_min):# and (499-imf_min_true_index[-1])>(mean_max_min+std_max_min)) :
                  ...
                  #  if len(small_index_max)>0 and coef_choice==1:
                  #      print "enter 1"
                  #      if len(small_index_max)>2:
                  #          max_index.append(sum(small_index_max[:2])/len(small_index_max[:2]))
                  #      else:
                  ...
                  #              min_index=[]
                    if len(small_index_max)>0 :#and imf_choice==1:
                        print "enter 1"
                        if len(small_index_max)>2:
                            max_index.append(sum(small_index_max[:2])/len(small_index_max[:2]))
                        elif len(small_index_max)==1 and self.buy_price==0:
                            if imf_max_remove_index!=[] and imf_max_remove_index[0]<495 and imf_max_remove_index[0]>small_index_max[0]:
                                max_index.append(imf_max_remove_index[0])
                        else:
                            max_index.append(sum(small_index_max[:])/len(small_index_max[:]))
                        if max_index!=[] and not self.judge_in_list(max_index[0],imf_min_remove_index):
                            small_index_min = list(filter(lambda n:n>max_index[-1], small_imf_min_index))
                            #if len(small_index_min)==1:
                            #    small_index_min = list(filter(lambda n:n>=max_index[-1], small_imf_min_index))
                            if len(small_index_min)==1:
                                pass                     
                            elif len(small_index_min)>=2:
                                min_index.append(sum(small_index_min[:])/len(small_index_min[:]))
                            if min_index!=[] and self.judge_in_list(min_index[0],imf_max_remove_index):
                                min_index=[]
                            if min_index!=[]:
                                small_index_max_2 = list(filter(lambda n:n>min_index[-1], small_imf_max_index))
                                if len(small_index_max_2)>=2:
                                    max_index.append(sum(small_index_max_2[:])/len(small_index_max_2[:]))
                    ...
                    if len(small_small_index_max)>0 and coef_choice==3:
                        print "enter 2"
                        max_index.append(sum(small_small_index_max[:])/len(small_small_index_max[:]))
                        small_small_index_min = list(filter(lambda n:n>=max_index[-1], small_small_imf_min_index))
             ...
             #       tmp.sort()
             #       if tmp!=[]:
             #           start = imf_min_true_index[-1]
             #           end = tmp[0]
             #           imf_seq = range(end-start+1)
             #           price_list = self.close_price[current_price_index-499:current_price_index+1]
             #           print imf_seq

             #           price_seq = price_list[start:end+1]
             #           print price_seq
             #           print "haha %s seq coef%s"%(i,np.corrcoef(price_seq,imf_seq)[0][1])
                    ...
                    if tmp!=[] and (tmp[-1] in max_index):
                        start = tmp[-1]
                        end = 499
                        imf_seq1 = range(end-start+1)
                        imf_seq = imf_seq1[::-1]
                        price_list = self.close_price[current_price_index-499:current_price_index+1]
                        print imf_seq
...
#                        imf_extrem_decision6 = 0
                    ...
                    print "imf deicison 9 %s"%imf_extrem_decision9
            ...
            #            imf_extrem_decision = -1
             ...
             #           residual = price_min_data
               ...
               #     if len(small_index_min)>0 and coef_choice==1:
               #         print "enter 1"
               #         print small_index_max
               ...
               #                 max_index=[]
                    ...
                    if len(small_index_min)>0 :#and imf_choice==1:
                        print "enter 1"
                        print small_index_max
                        print small_index_min
                        if len(small_index_min)>2:
                            min_index.append(sum(small_index_min[:2])/len(small_index_min[:2]))
                        elif len(small_index_min)==1 and self.buy_price==0:
                            if imf_min_remove_index!=[] and imf_min_remove_index[0]<495 and imf_min_remove_index[0]>small_index_min[0]:
                                min_index.append(imf_min_remove_index[0])
                        else:
                            min_index.append(sum(small_index_min[:])/len(small_index_min[:]))
                        print min_index
                        if min_index!=[] and not self.judge_in_list(min_index[0],imf_max_remove_index):
                            small_index_max = list(filter(lambda n:n>min_index[-1], small_imf_max_index))
                            #if len(small_index_max)==1:
                            #    small_index_max = list(filter(lambda n:n>=min_index[-1], small_imf_max_index))
                            ...
                            if len(small_index_max)==1:
                                ...
                                max_index.append(sum(small_index_max[:])/len(small_index_max[:]))
                            if max_index!=[] and self.judge_in_list(max_index[0],imf_min_remove_index):
                                max_index=[]
                            if max_index!=[]:
                                small_index_min_2 = list(filter(lambda n:n>max_index[-1], small_imf_min_index))
                                if len(small_index_min_2)>=2:
                                    min_index.append(sum(small_index_min_2[:])/len(small_index_min_2[:]))
                        else:
                            min_index=[]
                        #if min_index!=[] and max_index!=[]:
                        #    if max_index[0]-min_index[0]<2:
          ...
          #              print "haha %s seq coef%s"%(i,np.corrcoef(price_seq,imf_seq)[0][1])
                    ...
                    if max_index != []:
                        ...
                        if (tmp[-1] in max_index) and 499-max_index[-1]>(mean_max_min)-1.5 and 499-max_index[-1]<mean_max_min+2 :#+2*std_max_min :#and len(data)-max_index[-1]<mean_max_min+2*std_max_min:
                            imf_extrem_decision6 = -1
                        if (tmp[-1] in max_index) and tmp[-1]>=496:#max_index[-1]>(mean_max_min)-1.5 and 499-max_index[-1]<mean_max_min+2 :#+2*std_max_min :#and len(data)-max_index[-1]<mean_max_min+2*std_max_min:
                            imf_extrem_decision6 = 1
                    if min_index != []:
...
###############
        ...
        if len(self.buy_x_index)>1 and current_price_index-self.buy_x_index[-1]<3:
...
#####################################################################################################################
        ...
        #if macd_list[-1]>0  or (macd_list[-1]<0 and delta_macd_0>delta_macd_1):
...
############
        ...
        print " %s"%(ma20-ma30)
#########
        #if (self.ma_count<0 and macd_list[-1]>macd_list[-2]) or (self.ma_count>0 and ( delta_macd_0>delta_macd_1 or macd_list[-1]>macd_list[-2])):#macd_list[-1]>macd_list[-2]:#delta_macd_0>delta_macd_1 and delta_macd_1>delta_macd_2:
        if delta_macd_0>delta_macd_1 and delta_macd_1>delta_macd_2:
            macd_decision3=1
        print "macd3 %s"%macd_decision3
        macd_decision4=1
        if macd_list[-1]>macd_list[-2]>macd_list[-3]>macd_list[-4]>0:
            macd_decision4=0
        print "macd4 %s"%macd_decision4
        macd_decision5=0
        if macd_decision3==1 and macd_decision4==1:
            macd_decision5=1
        print "macd5 %s"%macd_decision5

        up_ma_decision1=1
        if up_decision1==0 and self.ma_count1<0 and self.ma_count1<self.ma_count:
            up_ma_decision1=0

        ma_decision4 = 1
        if self.ma_count1<0 and self.ma_count>0 and deltama5<0:
            ma_decision4 = 0
        ...
        #if macd_decision2==1 and distance_decision2 ==1 and self.buy_price!=0 and (imf_extrem_decision6==1 ) and ((trade_price-self.buy_price)/self.buy_price) >0:#and self.sell_decision==-1 and   ((self.macd[current_price_index]>0 and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]) or (self.macd[current_price_index]<self.macd[current_price_index-1] and self.macd[current_price_index]<0)) and self.share > 0 :
        if macd_decision2==1 and self.buy_price!=0 and (imf_extrem_decision6==1 ) and ((trade_price-self.buy_price)/self.buy_price) >0:#and self.sell_decision==-1 and   ((self.macd[current_price_index]>0 and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]) or (self.macd[current_price_index]<self.macd[current_price_index-1] and self.macd[current_price_index]<0)) and self.share > 0 :
            print "sell sell 1"
        ...
        elif  self.buy_price!=0 and (((self.buy_price-trade_price)/self.buy_price)>0.055 )  and self.share > 0 :
            print "sell sell 2"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
        ...
        elif self.buy_price!=0 and self.buy_day>10 and  imf_extrem_decision6 == 1 and self.share > 0 :
            print "sell sell 4"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
...
#            once_flag = 1
  ...
  #          self.holdtime = 0
  #          once_flag = 1
  #      elif up_ma_decision1==1 and  macd_decision5==1 and delta_buy_decision1==1 and  self.buy_price==0 and   imf_extrem_decision6==-1  :#and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]<self.macd[current_price_index-3]<self.macd[current_price_index-4]<self.macd[current_price_index-5] :#and small_imf_decision1 == -1:#imf_extrem_decision8 == 1 and buy_decision2 == -1:# and  self.close_price[current_price_index-1]<self.close_price[current_price_index]:# and imf_below_0_decision == -1:# and imf_power_decision == -1:
        elif  self.buy_price==0 and   imf_extrem_decision6==-1 and macd_decision3==1 :#and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]<self.macd[current_price_index-3]<self.macd[current_price_index-4]<self.macd[current_price_index-5] :#and small_imf_decision1 == -1:#imf_extrem_decision8 == 1 and buy_decision2 == -1:# and  self.close_price[current_price_index-1]<self.close_price[current_price_index]:# and imf_below_0_decision == -1:# and imf_power_decision == -1:
