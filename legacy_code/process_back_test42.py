...
#####
        ...
        ma4_list=ma_func2(self.close_price,4)
        ...
        ma_list=[ma2_list[i]-ma5_list[i] for i in range(len(self.close_price))]
        ma_list=[ma2_list[i]-ma4_list[i] for i in range(len(self.close_price))]
        #ma_list=[ma3_list[i]-ma5_list[i] for i in range(len(self.close_price))]
        ma10ma20de=0
...
###
        ...
        if  self.buy_price==0 and ( r==u_mean or ((ma_list[-1]>ma_2[-1]) and ma_list[-2]<ma_2[-2])):#and ma_list[-2]<np.mean(ma_list[-100:]) :#and ma_list[-2]<(np.mean(ma_list[-6:-1])-abs(np.std(ma_list[-6:-1]))) :#and np.mean(ma_list[-100:])>np.mean(ma_list[-101:-1]):# and ma_list[-1]-ma_list[-2]>0 and ma_list[-2]-ma_list[-3]<0:
        ...
        if   self.buy_price!=0 and (r1==a_mean or ((ma_list[-1]<ma_2[-1]) and ma_list[-2]>ma_2[-2])):#and ma_list[-2]<np.mean(ma_list[-100:]) :#and ma_list[-2]<(np.mean(ma_list[-6:-1])-abs(np.std(ma_list[-6:-1]))) :#and np.mean(ma_list[-100:])>np.mean(ma_list[-101:-1]):# and ma_list[-1]-ma_list[-2]>0 and ma_list[-2]-ma_list[-3]<0:
...
#
        ...
        data2 = ma_func2(self.close_price,60)
        peak_value=[]
        for i in self.peak:
       ...
       # data1 = ma_me
        ...
        plt.plot([i for i in range(len(data1))],data1,'o',[i for i in range(len(data1))],data1,'b',self.peak,peak_value,'yo',ma100)             
