...
#            once_flag = 1
  ...
  #          self.holdtime = 0
  #          once_flag = 1
        elif  self.buy_price==0 and   self.buy_decision == -1 :#and   power_ma5_decision==-1 :#and power_ma5_decision==-1:#imf_extrem_decision8 == 1 and buy_decision2 == -1:# and  self.close_price[current_price_index-1]<self.close_price[current_price_index]:# and imf_below_0_decision == -1:# and imf_power_decision == -1:
            print "buy buy 1"
