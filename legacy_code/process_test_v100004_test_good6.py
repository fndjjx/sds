...
##############
                    ...
                    if (imf_min_true_index[-1]>=495 and (self.last_last=="max")) :#and line_1_arc>line_2_arc:#and abs(((self.core+self.core2)/2.0)-current_core)>3 :#and abs(self.core-self.core3)<=2 and abs(self.core-self.core2)<=2:#est_per%2==0 and (yu<0.3 or yu>0.7):
                        down_test_decision1=-1
...
#######
        ...
        if   (self.ma_count<=self.ma_count2<0 and self.ma_count<=-5) or (self.ma_count1<=self.ma_count and self.ma_count1<0 and (np.corrcoef(macd_line,cri_sample)[0][1])<-0.85) :#and ((np.corrcoef(ma5_line,cri_sample)[0][1])<-0.9 :
            ma_decision3 = 0
