...
##############################################################
     ...
     #       small_imf_max_true_index = small_imf_max_index
        ...
        imf1_flag=0
        if small_imf_min_true_index[-1]>=495 and small_imf_min_true_index[-1]>small_imf_max_true_index[-1] :#and self.imf1_last_last=="max":
            imf1_flag=1
        ...
        if small_imf_max_true_index[-1]>=496 and small_imf_max_true_index[-1]>small_imf_min_true_index[-1] and self.imf1_last_last=="min":
            imf1_flag=2
        if small_imf_max_true_index[-1]<small_imf_min_true_index[-1] and 0.75<((small_imf_min_true_index[-1]-small_imf_max_true_index[-1])/float(499-small_imf_min_true_index[-1]))<1.3:
            imf1_flag=2
