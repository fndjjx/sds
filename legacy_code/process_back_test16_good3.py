...
########
        ...
        flag_fail=0
        if  self.buy_price!=0  and (power_ma5_de==2 ) :#and distance_decision2==1:#and ((current_price-self.buy_price)/self.buy_price)>0.01:#((deltamacd10<0 and deltamacd10_b>0)  ) and ((current_price-self.buy_price)/self.buy_price)>0.01:#(current_price<ma5 )and distance_decision2==1 and ((current_price-self.buy_price)/self.buy_price)>0.01:
