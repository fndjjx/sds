  ...
  #          decision = 1
   ...
   #         fp.writelines("\n")
    ...
    def run_predict_price_period(self,imf,current_price_index,residual):
        ...
        max_min_period_delta = self.max_min_period_delta[-10:]
        min_max_period_delta = self.min_max_period_delta[-10:]
...
##        power_current = self.close_price[current_price_index] - price_ma3_current
        ...
        if self.ma(self.close_price, 5, 0, current_price_index) > self.ma(self.close_price, 10, 0, current_price_index):
            ma_decision4 = 1
        else:
            ma_decision4 = 0
...
#        else:
#            ma_decision3 = 0
        if self.ma(self.close_price, 10, 0, current_price_index) < self.ma(self.close_price, 20, 0, current_price_index):
            ma_decision5 = 1
        else:
            ma_decision5 = 0
        ...
        if self.ma(self.close_price, 30, 0, current_price_index) > self.ma(self.close_price, 30, -1, current_price_index):
            ma_decision7 = 1
        else:
            ma_decision7 = 0
...
#        power_decision = period_decision
        ...
        if self.last_period_decision == 1 and decision != 1  and self.share>0 and (float(current_price)-float(self.buy_price))/float(self.buy_price)>0.015:
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
            ...
            self.sell_y_index.append(current_price)
        if decision == 1  and self.share>0 and (float(current_price)-float(self.buy_price))/float(self.buy_price)>0.0145 and self.share>0 :
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
            ...
            self.last_buy_flag = 0
            self.sell_y_index.append(current_price)
        if extrem_decision == 1  and self.share>0 :
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
            ...
            self.sell_x_index.append(current_price_index)
            self.sell_y_index.append(current_price)
        if decision == -1  and self.share>0 :
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
            ...
            self.sell_x_index.append(current_price_index)
            self.sell_y_index.append(current_price)
        if self.last_buy_flag == 0 and extrem_decision == -1  and self.share>0 :
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
...
#            self.sell_x_index.append(current_price_index)
#            self.sell_y_index.append(current_price)
        elif self.last_period_decision == -1 and extrem_decision == 0 and decision == 0  and self.money>0 and  ma_decision6 == 1 and ma_decision7 == 1 :#and ma_decision5 == 1:
            print "buy"
            self.share = self.buy(self.money,trade_price)
            self.money = 0
            self.buy_price = trade_price
