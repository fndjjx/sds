...
##############################################################
     ...
     #       small_imf_max_true_index = small_imf_max_index
        ...
        imf1_flag=0
        if 498>small_imf_min_true_index[-1]>=495 and small_imf_min_true_index[-1]>small_imf_max_true_index[-1] :#and self.imf1_last_last=="max":
            imf1_flag=1
        if small_imf_min_true_index[-1]<small_imf_max_true_index[-1] and 0.8<((small_imf_max_true_index[-1]-small_imf_min_true_index[-1])/float(499-small_imf_max_true_index[-1]))<1.2:
            imf1_flag=1
        ...
        if small_imf_max_true_index[-1]>=496 and small_imf_max_true_index[-1]>small_imf_min_true_index[-1] and self.imf1_last_last=="min":
            imf1_flag=2
        if small_imf_max_true_index[-1]>=496 and small_imf_max_true_index[-1]>small_imf_min_true_index[-1] and self.imf1_last_last=="max" and abs(self.imf1_core-current_imf1_core)>=4:
            imf1_flag=2
        if small_imf_max_true_index[-1]<small_imf_min_true_index[-1] and 0.75<((small_imf_min_true_index[-1]-small_imf_max_true_index[-1])/float(499-small_imf_min_true_index[-1]))<1.55:
            imf1_flag=2
...
#            self.ma_record=[]
  ...
  #      elif delta_macd1>delta_macd2 and macd_ma_decision==1 and  ma_decision3==1 and  self.buy_price==0 and  up_potion_decision2==1 and    down_test_decision1==-1 and delta_buy_decision1==1 :#and macd_decision3==1  :#imf_extrem_decision6==-1  :
        elif   ma_decision3==1 and self.fail_flag==0 and self.buy_price==0 and  price_flag==1 and imf0_flag==1 and imf1_flag==1 and delta_buy_decision1==1  :#imf_extrem_decision6==-1  :
...
if __name__ == "__main__":
    ...
    generate_emd_func.generate_ada_ma_emd_data_fix()
    print "begin %s"%begin
