...
###################
        ...
        if len(list(price_max_index)) > 0 and len(list(price_min_index)) > 0 :
            ...
            print " %s"%(ma20-ma30)
            ma_decision4=1
            if (self.ma_count1<self.ma_count<0) or (self.ma_count<self.ma_count2<-1 and self.ma_count1<2):
                ma_decision4=0
########################
...
#########
        ...
        ma_decision6=1
        if self.ma_count2<self.ma_count3<0 and self.ma_count1<0 :
            ma_decision6=0
        ma_decision7=0
...
##            once_flag = 1
  ...
  #          once_flag = 1
        ...
        elif  up_decision1==1 and self.buy_price==0 and ma_decision6==1 and down_test_decision1==-1 and ma_decision4==1 and delta_buy_decision1==1:#and macd_decision3==1  :#imf_extrem_decision6==-1  :
