...
class process_util():
    ...
    def __init__(self,open_price,close_price,macd,date,vol,high_price,low_price,je,kdjk,kdjd):
...
###
        current_k=self.kdjk[current_price_index]
        before_k=self.kdjk[current_price_index-1]
        before_k2=self.kdjk[current_price_index-2]
        current_d=self.kdjd[current_price_index]
        before_d=self.kdjd[current_price_index-1]
...
if __name__ == "__main__":
    ...
    (k,d)=kdj(close_price,high_price,low_price,5)
    process = process_util(open_price,close_price,macd,date,vol,high_price,low_price,je,k,d)
