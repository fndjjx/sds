...
#        power_decision = period_decision
        ...
        if self.last_period_decision == 1 and decision != 1  and self.share>0 and (float(current_price)-float(self.buy_price))/float(self.buy_price)>0.015:
            ...
            self.sell_y_index.append(current_price)
        elif decision == 1  and self.share>0 and (float(current_price)-float(self.buy_price))/float(self.buy_price)>0.0145 and self.share>0 :
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
            ...
            self.last_buy_flag = 0
            self.sell_y_index.append(current_price)
        elif extrem_decision == 1  and self.share>0 :
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
            ...
            self.sell_x_index.append(current_price_index)
            self.sell_y_index.append(current_price)
        elif decision == -1  and self.share>0 :
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
            ...
            self.sell_x_index.append(current_price_index)
            self.sell_y_index.append(current_price)
        elif self.last_buy_flag == 0 and extrem_decision == -1  and self.share>0 :
            print "sell"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
...
#            self.sell_x_index.append(current_price_index)
#            self.sell_y_index.append(current_price)
        elif self.last_period_decision == -1 and extrem_decision < 0 and decision == -1  and self.money>0 and  ma_decision6 == 1 and ma_decision7 == 1 :#and ma_decision5 == 1:
            print "buy"
            self.share = self.buy(self.money,trade_price)
            self.money = 0
            self.buy_price = trade_price
        ...
        elif (self.last_last_period_decision == -1 or self.last_period_decision == -1) and extrem_decision == -1 and self.money>0 and  ma_decision6 == 1 and ma_decision7 == 1 and ma_decision5 == 1:
            print "buy"
            self.share = self.buy(self.money,trade_price)
            self.money = 0
            self.buy_price = trade_price
