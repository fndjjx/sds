...
##############################################################
     ...
     #       small_imf_max_true_index = small_imf_max_index
        ...
        small_imf_max_true_index = filter(lambda n:n<496, small_imf_max_index)
        small_imf_min_true_index = filter(lambda n:n<496, small_imf_min_index)
...
######
                    ...
                    data = self.close_price[current_price_index-50:current_price_index+1]
                    ...
                    line_arc_before = np.arctan((line_before[-1]-line_before[0])/(len(line)-1))
                    line_arc_before2 = np.arctan((line_before2[-1]-line_before2[0])/(len(line_before2)-1))
                    line_arc_before3 = np.arctan((line_before3[-1]-line_before3[0])/(len(line_before3)-1))
...
#######
                    ...
                    if  line_arc>line_arc_before and line_arc_before<line_arc_before2<line_arc_before3:#and line_arc_before2<line_arc_before3 :#and line_arc_before3<line_arc_before4:#and line_arc<0.2:#and line_arc_before3<line_arc_before4 and line_arc_before4<line_arc_before5:
                        down_test_decision1=-1  
                    ...
                    if  ma_decision10==1 and ( line_arc>line_arc_before and line_arc_before<line_arc_before2) :#or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 )) and ma_decision10==1:
                        down_test_decision2=0   
                    if imf_min_true_index[-1]<486 :#or small_imf_max_true_index[-1]<small_imf_min_true_index[-1]:#or abs(data_line_arc)>0.3:
                        down_test_decision1=0   
                        down_test_decision2=0   
                    if self.buy_price!=0 and line_arc<line_arc_before and line_arc_before>line_arc_before2: 
                        down_test_decision1=1   
...
#                    if line_arc>line_arc_before>line_arc_before2 and line_arc_before2<line_arc_before3:
                    ...
                    if  line_arc>line_arc_before and line_arc_before<line_arc_before2<line_arc_before3 :
                        down_test_decision1=-1
                    #if line_arc>0 and line_arc_before<0 and line_arc_before2<0 :#and line_arc_before3<line_arc_before4:#and line_arc<0.2:#and line_arc_before3<line_arc_before4 and line_arc_before4<line_arc_before5:
                    #    down_test_decision1=0
                    if  ma_decision10==1 and ( line_arc>line_arc_before and line_arc_before<line_arc_before2) :#or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 )) and ma_de
                        down_test_decision2=0
                    if imf_max_true_index[-1]<486 :#or small_imf_max_true_index[-1]<small_imf_min_true_index[-1]:#or abs(data_line_arc)>0.3 :
                        down_test_decision1=0
                        down_test_decision2=0
                    if self.buy_price!=0 and line_arc<line_arc_before and line_arc_before>line_arc_before2:        
                        down_test_decision1=1
