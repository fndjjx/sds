...
#        #        imf_max_index.pop()
#        if imf_min_index[-1]>imf_max_index[-1] and imf_min_index[-1]>=97  :#and imf_min_index[-1]-imf_max_index[-1]>10:#and ex_flag==1:#and imf_process[-1]<0 :
#            imf2_flag=1
#        if imf_min_index[-1]<imf_max_index[-1] and imf_max_index[-1]>=97:
#            imf2_flag=2
#
#
#
...
###
    ...
    #        ma_list=self.buy_ma
        ...
        ma10 = ma_func2(self.close_price[current_price_index-499:current_price_index+1],10)
        ma_diff = [ma5[i]-ma10[i] for i in range(len(ma5))]
