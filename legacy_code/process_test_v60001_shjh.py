             ...
             #           residual = price_min_data
                  ...
                  #  print "choice %s"%choice
                    ...
                    if len(small_index_min)==1:
                        small_index_min = list(filter(lambda n:n>=imf_max_true_index[-1], small_imf_min_index))
...
#########
        ...
        ma_decision6=1
#        if self.ma_count<self.ma_count2 and self.ma_count<-10 and self.ma_count1<3:
#            ma_decision6=0
        ...
        macd_decision7=1
        if len(macd_max)==1 and macd_list_10[-1]>macd_list_10[-2]>0:
            macd_decision7=0
