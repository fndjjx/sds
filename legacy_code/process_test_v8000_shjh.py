...
##############################################################
        ...
        if coef_list2[2]>0.85 and self.buy_price==0 :
            coef_choice=2
        elif self.buy_price!=0 or (self.buy_price==0 and coef_list2[2]<0.85 and coef_list2[1]>coef_list2[0] and coef_list1[1]>0 and coef_list1[1]>coef_list1[0]):#and coef_list1[2]>0:
            coef_choice=1
