...
##############################################################
        ...
        if (small_imf_min_index[-1]>small_imf_max_index[-1]) or (small_imf_min_index[-1]<small_imf_max_index[-1] and small_imf_max_index[-1]<497):
...
#            once_flag = 1
  ...
  #          self.holdtime = 0
  #          once_flag = 1
        elif self.buy_price==0 and   imf_extrem_decision6==-1  and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]<self.macd[current_price_index-3]<self.macd[current_price_index-4] :#imf_extrem_decision8 == 1 and buy_decision2 == -1:# and  self.close_price[current_price_index-1]<self.close_price[current_price_index]:# and imf_below_0_decision == -1:# and imf_power_decision == -1:
