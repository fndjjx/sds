...
############
        ...
        if self.buy_price==0:
            ...
            date = date.replace(" ","")
            trade_price=getanytime(self.mindata,date,"10:00:00")
...
####
      #  pp2=leastsqt_predict(self.close_price[current_price_index-10:current_price_index],1)[0]
      #  zhi5=close_price[current_price_index-1]+close_price[current_price_index-2]+close_price[current_price_index-3]+close_price[current_price_index-4]
      #  zhi5=zhi5+pp2
      #  zhi2=close_price[current_price_index-1]+pp2
      ...
      #  print "nearprice %s"%nearprice
      #  print "close %s"%self.close_price[current_price_index]
...
###
        ...
        zhi5_base=self.close_price[current_price_index]+self.close_price[current_price_index-1]+self.close_price[current_price_index-2]+self.close_price[current_price_index-3]
        zhi5=zhi5_base+pp2
        ...
        date = self.date[current_price_index+1].replace("/","-")
        date = date.replace(" ","")
        halfprice=float(getanytime(self.mindata,date,"10:00:00"))

        
        zhi5=zhi5_base+halfprice
        zhi2=self.close_price[current_price_index]+halfprice
        rz=zhi2/2.0-zhi5/5.0

        print "rz%s"%rz

##
        if len(self.pre_cha)>1 and self.pre_cha[-2]>0 and (zhi-rz)<0:
            prechabig0=1 
...
##
            ...
            #halfprice=float(getanytime(mindata,c_date,"10:30:00"))
