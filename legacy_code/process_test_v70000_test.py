            ...
            if 1:#self.buy_price == 0:# and abs(self.last_true_max-imf_max_true_index[-1])<10 and abs(self.last_true_min-imf_min_true_index[-1])<10:#(buyhigh/buyhigh2)>0.3 and (buyhigh/buyhigh2)<3:
                ...
                if imf_max_true_index[-1]<imf_min_true_index[-1]:# and 499-imf_min_true_index[-1]>(mean_min_max):# and imf_min_true_index[-1]>465:# and 499-imf_max_true_index[-1]<(mean_min_max+mean_max_min):# and (499-imf_min_true_index[-1])>(mean_max_min+std_max_min)) :
                 ...
                 #   print "choice %s"%choice
                    ...
                    #if yu>3:
                    #    dd = data[-yu:]
                    #    print " dd %s"%(np.std(dd)/np.mean(dd))
                    print "\n\n\n"
                    ...
                    if (duan==3 and up_test[0]>0 and down_test[-1]>0.5) or (duan==2 and up_test[0]>0 and down_test[1]>0.5) or (down_test[-1]>0.5 and len(dd)>5) or (duan==3 and up_test[0]>0 and 0<up_test[-1]<up_test[-2]):
                  ...
                  #          min_index.append(sum(small_index_min)/len(small_index_min))
                    ...
                    #if len(small_index_max)>0 :#and (choice==1 or choice==2):
                    #    print "enter 1"
                    #    if len(small_index_max)>2 and flag==1: 
                    #        max_index.append(sum(small_index_max[:3])/len(small_index_max[:3]))
                    #    elif len(small_index_max)>=2 and flag==0:
                    #        max_index.append(sum(small_index_max[:2])/len(small_index_max[:2]))
                    #    elif len(small_index_max)==2 and flag==1:
                    #        #max_index.append(sum(small_index_max[1:1])/len(small_index_max[1:1]))
                    #        max_index.append((small_index_max[1]))
                    #    elif len(small_index_max)==1 and flag==0:
                    #        max_index.append((small_index_max[0]))
                    #    
                    #    small_index_min = list(filter(lambda n:n>max_index[-1], small_imf_min_index))
                    #    small_index_min_remove = list(filter(lambda n:n<=max_index[-1], small_imf_min_index))
                    #    small_index_min.insert(0,small_index_min_remove[-1]) 

                    #    if len(small_index_min)>2:
                    #        min_index.append(sum(small_index_min[:3])/len(small_index_min[:3]))
                    #    elif len(small_index_min)==2:
                    #        #min_index.append(sum(small_index_min[1:1])/len(small_index_min[1:1]))
                    #        min_index.append((small_index_min[1]))
                    #    if min_index!=[] and max_index!=[]:
                    #        if min_index[0]-max_index[0]<3:
                    #            min_index=[]
                    

                    if len(small_small_index_max)>0 :
                        print "enter 2"
                        if imf_min_true_index[-1]-small_small_index_max_remove[-1]<2 and (imf_min_true_index[-1]-small_small_index_max_remove[-1])<(small_small_index_max[0]-imf_min_true_index[-1]):
                            small_small_index_max.insert(0,small_small_index_max_remove[-1]) 
                        if len(small_small_index_max)>2 :
                            max_index.append(sum(small_small_index_max[:3])/len(small_small_index_max[:3]))
                        else:
                    ...
                    print "tmp 1 %s "%tmp
              #      if tmp!=[] :#and choice==2:
              #          if tmp[-1] in max_index:
              #              small_small_index_min = list(filter(lambda n:n>max_index[-1], small_small_imf_min_index))
              #              if len(small_small_index_min)<=1:
              #                  pass
              #              else:
              #                  min_index.append(sum(small_small_index_min[:])/len(small_small_index_min[:]))
              #          if tmp[-1] in min_index:
              #              small_small_index_max = list(filter(lambda n:n>min_index[-1], small_small_imf_max_index))
              #              if len(small_small_index_max)<=1:
              #                  pass
              #              else:
              #                  max_index.append(sum(small_small_index_max[:])/len(small_small_index_max[:]))
            ...
            #            imf_extrem_decision = -1
             ...
             #           residual = price_min_data
              ...
              #          print " dd %s"%(np.std(dd)/np.mean(dd))
                    ...
                    if (duan==3 and down_test[0]>0 and  down_test[-1]>0.5) or (down_test[-1]>0.5 and len(dd)>5):# or (duan==2 and down_test[0]>0.5):
                        down_test_decision = -1
                    if up_test1[0]>0.7:
                        down_test_decision = 0
                    if (duan==3 and down_test[0]>0 and down_test[1]>0 and down_test[2]>0) or (duan==2 and down_test[0]>0 and down_test[1]>0):
                  ...
                  #          max_index.append(sum(small_index_max)/len(small_index_max))
                   ...
                   # if len(small_index_min)>0 :#and (choice==1 or choice==2):
                   #     print "enter 1"
                   #     print small_index_max
                   #     print small_index_min
                   #     if len(small_index_min)>2 and flag==1:
                   #         min_index.append(sum(small_index_min[:3])/len(small_index_min[:3]))
                   #     if len(small_index_min)>=2 and flag==0:
                   #         min_index.append(sum(small_index_min[:2])/len(small_index_min[:2]))
                   #     elif len(small_index_min)==1 and flag==0:
                   #         min_index.append((small_index_min[0]))
                   #     elif len(small_index_min)==2 and flag==1:
                   #         min_index.append((small_index_min[1]))
                   #     small_index_max = list(filter(lambda n:n>min_index[-1], small_imf_max_index))
                   #     small_index_max_remove = list(filter(lambda n:n<=min_index[-1], small_imf_max_index))
                   #     small_index_max.append(small_index_max_remove[-1])
                   #         
                   #     if len(small_index_max)>2:
                   #         max_index.append(sum(small_index_max[:3])/len(small_index_max[:3]))
                   #     elif len(small_index_max)==2:
                   #         max_index.append((small_index_max[1]))
                   #     if min_index!=[] and max_index!=[]:
                   #         if max_index[0]-min_index[0]<3:
                   #             max_index=[]

                    if len(small_small_index_min)>0 :
                        print "enter 3"
                        if imf_max_true_index[-1]-small_small_index_min_remove[-1]<2 and (imf_max_true_index[-1]-small_small_index_min_remove[-1])<(small_small_index_min[0]-imf_max_true_index[-1]):
                            small_small_index_min.insert(0,small_small_index_min_remove[-1]) 
                        if len(small_small_index_min)>2 :
                            min_index.append(sum(small_small_index_min[:3])/len(small_small_index_min[:3]))
                        else :
                            min_index.append(sum(small_small_index_min[:])/len(small_small_index_min[:]))
                            small_small_index_max = list(filter(lambda n:n>=min_index[-1], small_small_imf_max_index))
                            if len(small_small_index_max)>0:
...
###############
        price_50 = self.close_price[current_price_index-24:current_price_index+1]
        up_list = [price_50[i+1]-price_50[i] for i in range(24) if price_50[i]<price_50[i+1]]
        down_list = [price_50[i+1]-price_50[i] for i in range(24) if price_50[i]>price_50[i+1]]
        print up_list
        print down_list
        up_potion = abs((sum(up_list)/sum(down_list)))
...
#########
        ...
        ma_decision4=1
        if (self.ma_count1<0 and self.ma_count<0 and self.ma_count2<0 and self.ma_count3<0) or (self.ma_count<0 and self.ma_count<self.ma_count2 and self.ma_count3<0):
            ma_decision4=0
        ...
        ma_decision6=1
        if self.ma_count1<self.ma_count<0 and self.ma_count2>0 :
            ma_decision6=0
        ...
        if current_price>self.open_price[current_price_index] :#and trade_price>current_price:#>self.close_price[current_price_index-1]:
        ...
        print "up deicision%s"%up_ma_decision1
        ...
        print "down_test_decision deicision%s"%down_test_decision
 ...
 #       if distance_decision2 ==1 and self.buy_price!=0 and (imf_extrem_decision6==1 ) and ((trade_price-self.buy_price)/self.buy_price) >0.01:#and self.sell_decision==-1 and   ((self.macd[current_price_index]>0 and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]) or (self.macd[current_price_index]<self.macd[current_price_index-1] and self.macd[current_price_index]<0)) and self.share > 0 :
        if  down_test_decision==1:#(imf_extrem_decision6==1 ) :#and self.sell_decision==-1 and   ((self.macd[current_price_index]>0 and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]) or (self.macd[current_price_index]<self.macd[current_price_index-1] and self.macd[current_price_index]<0)) and self.share > 0 :
            print "sell sell 1"
            print "open%s close%s"%(self.open_price[current_price_index],current_price)
...
#        elif  self.buy_price!=0 and (((self.buy_price-trade_price)/self.buy_price)>0.04 )  and self.share > 0 :
#            print "sell sell 2"
#            self.money = self.sell(self.share,trade_price)
#            self.share = 0
#            self.buy_price = 0
...
#        elif self.buy_price!=0 and self.buy_day>5 and   (imf_extrem_decision == 1 or current_price>self.buy_price) and self.share > 0 :
#            print "sell sell 4"
#            self.money = self.sell(self.share,trade_price)
#            self.share = 0
#            self.buy_price = 0
...
#            self.last_buy_result=3
  ...
  #          once_flag = 1
        ...
        elif up_ma_decision1==1 and open_close_decision1==1 and down_test_decision==-1 and macd_decision3==1  :#imf_extrem_decision6==-1  :
...
if __name__ == "__main__":
    ...
    for eachline in lines:
        ...
        #vol.append(float(eachline.split("\t")[1]))
