...
#######
        ...
        if  self.buy_price!=0  and ((deltamacd10<0 and deltamacd10_b>0)  ) and ((current_price-self.buy_price)/self.buy_price)>0.01:#(current_price<ma5 )and distance_decision2==1 and ((current_price-self.buy_price)/self.buy_price)>0.01:
            ...
            self.sell_flag=0
            self.sell_flag2=0
        elif self.buy_price!=0 and ((((self.buy_price-current_price)/self.buy_price)>0.08 ) )  and self.share > 0 :
            print "sell sell 4"
            if self.buy_price>=trade_price:
                self.fail_flag=1
            else:
    ...
    def run(self,emd_data, datafile,current_index,date,emd_file,emd_data2,emd_data3,preflag):
        ...
        my_emd = one_dimension_emd(emd_data2,5)
