...
#######
        ...
        deltama40 = self.ma(self.close_price, 40, 0, current_price_index)-self.ma(self.close_price, 40, -1, current_price_index)
        deltama50 = self.ma(self.close_price, 50, 0, current_price_index)-self.ma(self.close_price, 50, -1, current_price_index)
...
######
        ...
        ma_list=[deltama10,deltama20,deltama40,deltama30,deltama50]
        mac=0
        for i in ma_list:
            if i>0:
                mac+=1
