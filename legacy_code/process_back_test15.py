...
class process_util():
    ...
    def run_predict1(self,imf_list,current_price_index,date,datafile,residual,imf_open,imf_macd,sel_flag,emd_data):
...
###########################
    ...
    def run_predict(self,imf_list,current_price_index,date,datafile,residual,emd_data,imf_open,imf_macd,emd_std,preflag,emd_data2):
        (imf_close_flag,last_max)=self.run_predict1(imf_list,current_price_index,date,datafile,residual,imf_open,imf_macd,2,emd_data)
...
#            imf_flag=1
        if self.buy_price!=0 and (imf_close_flag==2):# and imf_high_flag!=1) or (imf_high_flag==2 and imf_close_flag!=1):#and imf_high_flag==2:
...
#######
        ...
        macdma5 = self.ma(self.macd, 3, 0, current_price_index)
        macdma5_before = self.ma(self.macd, 3, -1, current_price_index)
        macdma5_before2 = self.ma(self.macd, 3, -2, current_price_index)
        macdma5_before3 = self.ma(self.macd, 3, -3, current_price_index)
