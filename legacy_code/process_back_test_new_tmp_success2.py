...
#
        ...
        ma_list = [ma2_list[i]-ma2_ma2_list[i] for i in range(len(ma2_list))]
        ma_list = [self.close_price[i]-ma3_list[i]  for i in range(len(ma2_list))]
        data1 = ma_list
