...
#######
        ...
        price_decision1=0
        if self.buy_price==0:
            if self.open_price[current_price_index+1]==self.low_price[current_price_index+1]:
        ...
        if self.buy_price!=0:
            if self.open_price[current_price_index+1]==self.high_price[current_price_index+1]:
                trade_price = self.close_price[current_price_index+1]
            else:
                trade_price = self.open_price[current_price_index+1]
...
#            self.ma_record=[]
  ...
  #      elif delta_macd1>delta_macd2 and macd_ma_decision==1 and  ma_decision3==1 and  self.buy_price==0 and  up_potion_decision2==1 and    down_test_decision1==-1 and delta_buy_decision1==1 :#and macd_decision3==1  :#imf_extrem_decision6==-1  :
        elif   price_decision1==1 and ma_decision4==1 and ma_decision3==1 and self.fail_flag==0 and self.buy_price==0 and  imf0_flag==1 and imf1_flag==1 and delta_buy_decision1==1  :#imf_extrem_decision6==-1  :
...
#        (imf, residual) = my_emd.emd(0.03,0.03)
        ...
        (imf0,imf1,imf2,imf3)= my_eemd.eemd_process(emd_data,50)
        imf=[]
        imf.append(imf0)
        imf.append(imf1)
        imf.append(imf2)
