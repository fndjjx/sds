...
###
        ...
        sel = 1
        if sel==1:
            if  diffmp[-1]<0 and mean_de==1 and   len(self.mclist2)>0 and self.mclist2[-1]>0 and rdde==1:#and self.fail_flag==0) or (self.fail_flag==1 and len(self.mclist5)>0 and self.mclist5[-1]<0)):
                jede=1
