...
##############################################################
        ...
        if imf_min_index[-1]>imf_max_index[-1] and imf_min_index[-1]>=46 :
            imf_flag=1
...
#######
        ...
        deltama3_before4 = self.ma(self.close_price, 3, -4, current_price_index)-self.ma(self.close_price, 3, -5, current_price_index)
        ...
        ma3_b6 = self.ma(self.close_price, 3, -6, current_price_index)
        ma3_b7 = self.ma(self.close_price, 3, -7, current_price_index)
        ...
        mama3_b4 = (ma3_b4+ma3_b5+ma3_b6)/3.0
        mama3_b5 = (ma3_b5+ma3_b6+ma3_b7)/3.0

        mamama3 = (mama3+mama3_b+mama3_b2)/3.0
        mamama3_b = (mama3_b+mama3_b2+mama3_b3)/3.0
        mamama3_b2 = (mama3_b2+mama3_b3+mama3_b4)/3.0
        mamama3_b3 = (mama3_b3+mama3_b4+mama3_b5)/3.0
...
###################
        ...
        delay_decision=0
        if  ((current_price-self.close_price[current_price_index-3])/self.close_price[current_price_index-3])<0.02 and (current_price-self.close_price[current_price_index-3])>0:
        #if ((mamama3-mamama3_b3)/mamama3_b3)<0.01 and (mamama3-mamama3_b3)>0:
            delay_decision=1
        if  current_price-self.close_price[current_price_index-3]<0:
            delay_decision=1
...
########
        ...
        print "delta ma3 before %s %s "%(deltama3_before2,deltama3_before)
...
#######
        ...
        if  ((imf_flag==2 ) or (deltama5<deltama5_before)) and  self.buy_price!=0  and ((current_price-self.buy_price)/self.buy_price) >0:
            ...
            self.buy_mean_price = 0
            self.one_time_day=0
        elif    imf_flag==1  and  deltama3_before2>deltama3_before and deltama3>deltama3_before and self.buy_price==0 :#and delay_decision==1:#and  deltama3_before4>deltama3_before3 :
            if self.fail_flag!=0:
                self.fail_flag-=1
            else:
                print "buy buy 1"
