...
##############
                    ...
                    if (imf_min_true_index[-1]>=495 and (self.last_last=="max")):#and abs(((self.core+self.core2)/2.0)-current_core)>3 :#and abs(self.core-self.core3)<=2 and abs(self.core-self.core2)<=2:#est_per%2==0 and (yu<0.3 or yu>0.7):
                        down_test_decision1=-1
