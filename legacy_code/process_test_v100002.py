...
###################
        ...
        if len(list(price_max_index)) > 0 and len(list(price_min_index)) > 0 :
            ...
            imf_max_true_index = list(filter(lambda n:n<494,imf_max_index))
            imf_min_true_index = list(filter(lambda n:n<494,imf_min_index))
            ...
            print " %s"%(ma20-ma30)
            ma_decision10=0
            if self.ma_count2>self.ma_count3>10 :#and (self.ma_count1>self.ma_count or (self.ma_count1>3 and self.ma_count>0))) :
                ma_decision10=1
########################
...
#
                    ...
                    self.down_test.append(down_test[-1])
                    #if down_test[-1]>0.6 and  (down_test[-1]>down_test[-2]) and down_test[-1]<down_test_before:
                    #if  0.95>down_test[-1]>0.2 and down_test[-1]<down_test_before  and fluct==-1 :#and down_test1[0]>0:#and down_test_before>down_test_before2 and down_test_before2>down_test_before3 and down_test1[0]>0:#and down_test[-2]>-0.3:
                    if  ( down_test[-1]>0.3 and down_test_before>0.5 and down_test[-1]<down_test_before and down_test_before<down_test_before2 and down_test_before2>down_test_before3) :#or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 and down_test_before2>0.5 and down_test_before>0.5 ) :
                        down_test_decision1=-1   
#                    if  ( down_test[-1]>0.3 and down_test_before>0.5 and down_test[-1]<down_test_before and down_test_before>down_test_before2 ) :#or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 and down_test_before2>0.5 and down_test_before>0.5 ) :
#                        down_test_decision1=-1   
                    if down_test_before>0.6 and -0.4<down_test[-1]<0.2 :
                        down_test_decision1=-1   
                    if  ma_decision10==1 and (down_test[-1]<down_test_before and down_test_before>down_test_before2 ) :#or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 )) and ma_decision10==1:
                        down_test_decision2=-1   
                    #if self.ma_count2<0  and (self.ma_count<0 or self.ma_count3<0) and down_test1[0]>0.35:
                   # if (self.ma_count1<self.ma_count<-5 or self.ma_count<self.ma_count2<self.ma_count3<0 ) and down_test1[0]>0.35 :#(or self.ma_count<self.ma_count2<0 or self.ma_count2<self.ma_count3<0 and down_test1[0]>0.35:
                   #     down_test_decision1=0   
                    if down_test1[0]<-0.6 or imf_min_true_index[-1]<486:
                        down_test_decision1=0   
                    #if down_test[-1]<-0.5 or down_test[-1]>0.8:#or fluct==1:
                    #    down_test_decision1=0
                    if self.buy_price!=0 and down_test[-1]>down_test_before and down_test_before<down_test_before2: 
                        down_test_decision1=1   
#                    if self.buy_price!=0 and down_test[-1]<down_test_before<-0.85:# and down_test_before>down_test_before2: 
#                        down_test_decision1=1   
#                    if self.buy_price!=0 and down_test_before<0 and down_test[-1]>0:
#                        down_test_decision1=1
                    if self.buy_day>8 and self.buy_price!=0 and down_test_before2>down_test_before>down_test[-1]:
                        down_test_decision1=2
...
#                    last_five_before4 = data[-7:-4]
                    ...
                    self.down_test.append(down_test[-1])
           #         if down_test[-1]>0.6  and (down_test[-1]>down_test[-2]) and down_test[-1]<down_test_before:
                    #if  ((down_test_before2>0.3 and  0.95>down_test[-1]>0 and down_test_before>0.5 and down_test[-1]<down_test_before ) or (down_test[-1]>-0.1 and 0.95>down_test_before>0 and down_test_before2>0.5 and down_test[-1]<down_test_before<down_test_before2 )) :#and imf_max_true_index[-1]>488:#and down_test1[0]>0.5:#and down_test_before>down_test_before2 and down_test_before2>down_test_before3 and down_test1[0]>0.5:#and down_test[-2]>-0.6:
#                    if  (( 0.95>down_test[-1]>0 and down_test_before>0.5 and down_test[-1]<down_test_before and down_test_before>down_test_before2 and down_test_before2>down_test_before3) or (down_test[-1]>-0.1 and 0.95>down_test_before>0 and down_test_before2>0.5 and down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2)) :#and imf_max_true_index[-1]>488:#and down_test1[0]>0.5:#and down_test_before>down_test_before2 and down_test_before2>down_test_before3 and down_test1[0]>0.5:#and down_test[-2]>-0.6:
                    if  down_test[-1]>0.3 and imf_max_true_index[-1]>488 and ( down_test_before>0.5 and down_test[-1]<down_test_before  and down_test_before<down_test_before2 and down_test_before2>down_test_before3 ) :#or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 and down_test_before2>0.5 and down_test_before2>0.5 ) :#and imf_max_true_index[-1]>488:#and down_test1[0]>0.5:#and down_test_before>down_test_before2 and down_test_before2>down_test_before3 and down_test1[0]>0.5:#and down_test[-2]>-0.6:
                        down_test_decision1=-1
                    #if  down_test[-1]>0.3 and imf_max_true_index[-1]>488 and ( down_test_before>0.5 and down_test[-1]<down_test_before  and down_test_before>down_test_before2) :#or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 and down_test_before2>0.5 and down_test_before2>0.5 ) :#and imf_max_true_index[-1]>488:#and down_test1[0]>0.5:#and down_test_before>down_test_before2 and down_test_before2>down_test_before3 and down_test1[0]>0.5:#and down_test[-2]>-0.6:
                     #   down_test_decision1=-1
                    if down_test_before>0.6 and -0.4<down_test[-1]<0.2 :
                        down_test_decision1=-1
                    if  ma_decision10==1 and (down_test[-1]<down_test_before and down_test_before>down_test_before2 ) :#or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 )) and ma_decision10==1:
                    ...
                    #if (self.ma_count1<self.ma_count<-5 or self.ma_count<self.ma_count2<self.ma_count3<0 ) and down_test1[0]>0.35 :#or self.ma_count<self.ma_count2<0 or self.ma_count2<self.ma_count3<0 and down_test1[0]>0.35:
                    #    down_test_decision1=0
                    #if fluct==-1 or down_test[-1]>0.85 or down_test[-1]<-0.5:#or fluct==1:
                    #if down_test[-1]<-0.5 or down_test[-1]>0.8:#or fluct==1:
                    #    self.fluct_flag=1
                    #    down_test_decision1=0
                    if  self.buy_price!=0 and down_test[-1]>down_test_before and down_test_before<down_test_before2:
...
#####################################################################################################################
        ...
        if deltama5<0 and deltama10<0 and deltama20<0 and deltama30<0:
            ma_decision2 = 0
        ma_decision3 = 1
        if  self.ma_count1<self.ma_count<0 and self.ma_count1<self.ma_count2<0:
            ma_decision3 = 0
...
#########
        ...
        if self.last_buy_result==1 or self.last_buy_result==3 or self.last_buy_result==4:
            if current_price_index-self.sell_x_index[-1]<4:
        ...
        if up_potion>1.25 and self.ma_count3<0:
 ...
 #       if distance_decision2 ==1 and self.buy_price!=0 and (imf_extrem_decision6==1 ) and ((trade_price-self.buy_price)/self.buy_price) >0.01:#and self.sell_decision==-1 and   ((self.macd[current_price_index]>0 and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]) or (self.macd[current_price_index]<self.macd[current_price_index-1] and self.macd[current_price_index]<0)) and self.share > 0 :
        if  self.buy_price!=0 and down_test_decision1==1 and ((trade_price-self.buy_price)/self.buy_price) >0.01:#(imf_extrem_decision6==1 ) :#and self.sell_decision==-1 and   ((self.macd[current_price_index]>0 and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]) or (self.macd[current_price_index]<self.macd[current_price_index-1] and self.macd[current_price_index]<0)) and self.share > 0 :
            print "sell sell 1"
            print "open%s close%s"%(self.open_price[current_price_index],current_price)
        ...
        elif self.buy_price!=0 and self.buy_day>8 and   (down_test_decision1==1 or down_test_decision1==2 or current_price>self.buy_price) and self.share > 0 :
            print "sell sell 5"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
...
##            self.holdtime = 0
##            once_flag = 1
        elif self.buy_price!=0 and down_test[-1]<-0.8 and distance_decision==1 and ((current_price-self.buy_price)/self.buy_price) >0.04 and self.share > 0 :
            print "sell sell 3"
            print "open%s close%s"%(self.open_price[current_price_index],current_price)
            self.money = self.sell(self.share,trade_price)
            self.share = 0
  ...
  #          once_flag = 1
        ...
        elif  up_decision1==1 and self.buy_price==0 and down_test_decision1==-1 and delta_buy_decision1==1:#and macd_decision3==1  :#imf_extrem_decision6==-1  :
            ...
            print "delta ma30 %s"%deltama30
            self.last_buy_result=0
        elif  self.buy_price==0 and down_test_decision1!=1 and down_test_decision2==-1 and delta_buy_decision1==1:#and macd_decision3==1  :#imf_extrem_decision6==-1  :
        #elif macd_decision1==1 and self.buy_price==0 and   imf_extrem_decision6==-1  and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]<self.macd[current_price_index-3]<self.macd[current_price_index-4] and small_imf_decision1==-1 and self.macd[current_price_index]<0.5 and  self.macd[current_price_index]>-1:#imf_extrem_decision8 == 1 and buy_decision2 == -1:# and  self.close_price[current_price_index-1]<self.close_price[current_price_index]:# and imf_below_0_decision == -1:# and imf_power_decision == -1:
            print "buy buy 2"
            print "vol %s"%self.vol[current_price_index-5:current_price_index+1]
            print "open%s close%s"%(self.open_price[current_price_index-1],self.close_price[current_price_index-1])
...
#            self.buy_decision = 0
   ...
   #         imf.pop()
        ...
        plt.subplot(312).axis([start,len(imf),min(imf[start:]),max(imf[start:])])
...
#####
        ...
        plt.subplot(313)
        plt.plot([i for i in range(len(self.down_test))],self.down_test,'b',buy_x_down_test,buy_y_down_test,'r*',sell_x_down_test,sell_y_down_test,'g*')             
