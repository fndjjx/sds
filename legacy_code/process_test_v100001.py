...
#######################################
                    ...
                    if  (( down_test_before>0.5 and down_test[-1]<down_test_before and down_test_before>down_test_before2 and down_test_before2>down_test_before3) or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 and down_test_before2>0.5 and down_test_before>0.5 )) :
                        down_test_decision1=-1   
                    if  (( down_test[-1]<down_test_before and down_test_before>down_test_before2 and down_test_before2>down_test_before3) or ( down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2 )) and ma_decision10==1:
                   ...
                   #     down_test_decision1=0   
                    if down_test1[0]<-0.5 or imf_min_true_index[-1]<486:
                        down_test_decision1=0   
                    if down_test[-1]<-0.5:#or fluct==1:
                        down_test_decision1=0
                    if down_test[-1]<-0.5 and down_test[-1]<down_test_before and down_test_before>down_test_before2: 
                        down_test_decision1=1   
                    #if down_test[-1]<down_test_before<-0.85:# and down_test_before>down_test_before2: 
                    #    down_test_decision1=1   
                    if down_test_before<0 and down_test[-1]>0:
                        down_test_decision1=1
...
#                    if  (( 0.95>down_test[-1]>0 and down_test_before>0.5 and down_test[-1]<down_test_before and down_test_before>down_test_before2 and down_test_before2>down_test_before3) or (down_test[-1]>-0.1 and 0.95>down_test_before>0 and down_test_before2>0.5 and down_test[-1]<down_test_before<down_test_before2 and down_test_before3<down_test_before2)) :#and imf_max_true_index[-1]>488:#and down_test1[0]>0.5:#and down_test_before>down_test_before2 and down_test_before2>down_test_before3 and down_test1[0]>0.5:#and down_test[-2]>-0.6:
                    ...
                    if  down_test[-1]<-0.5 and down_test[-1]<down_test_before and down_test_before>down_test_before2:
                        down_test_decision1=1
                    if  down_test[-1]<down_test_before<-0.8 :#and down_test_before>down_test_before2:
                        down_test_decision1=1
                    #if down_test_before<0 and down_test[-1]>0:
                    #    down_test_decision1=1
                    if self.buy_day>8 and self.buy_price!=0 and down_test_before2>down_test_before>down_test[-1]:
...
#########
        ...
        ma_decision6=1
        if (self.ma_count1<0 and delta_power_current<0) or (self.ma_count1<self.ma_count<0 ) or (self.ma_count1<0 and self.ma_count<0 and self.ma_count2<0 and self.ma_count3<-10) or self.ma_count<self.ma_count2<0 or (self.ma_count1<self.ma_count and self.ma_count2<self.ma_count3<0 ):
            ma_decision6=0
        ma_decision7=0
 ...
 #       if distance_decision2 ==1 and self.buy_price!=0 and (imf_extrem_decision6==1 ) and ((trade_price-self.buy_price)/self.buy_price) >0.01:#and self.sell_decision==-1 and   ((self.macd[current_price_index]>0 and self.macd[current_price_index]<self.macd[current_price_index-1]<self.macd[current_price_index-2]) or (self.macd[current_price_index]<self.macd[current_price_index-1] and self.macd[current_price_index]<0)) and self.share > 0 :
        ...
        elif  self.buy_price!=0 and (((self.buy_price-current_price)/self.buy_price)>0.05 )  and self.share > 0 and macd_decision8==1:
            print "sell sell 2"
            self.money = self.sell(self.share,trade_price)
            self.share = 0
            self.buy_price = 0
...
##            self.holdtime = 0
##            once_flag = 1
        elif self.buy_price!=0 and distance_decision==1 and ((current_price-self.buy_price)/self.buy_price) >0.045 and self.share > 0 :
            print "sell sell 3"
            print "open%s close%s"%(self.open_price[current_price_index],current_price)
            self.money = self.sell(self.share,trade_price)
            self.share = 0
  ...
  #          once_flag = 1
        ...
        elif  up_decision1==1 and self.buy_price==0 and ma_decision6==1 and down_test_decision1==-1 and delta_buy_decision1==1:#and macd_decision3==1  :#imf_extrem_decision6==-1  :
