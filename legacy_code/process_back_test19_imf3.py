...
#       #     (imf_process,extenflag1,ex_num) = matchlist3(imf_process)
        ...
        imf2_max_index = list(argrelextrema(np.array(imf_list[3]),np.greater)[0])
        imf2_min_index = list(argrelextrema(np.array(imf_list[3]),np.less)[0])
        ...
        if i==1 :#or tmp[-2]<990:
            (imf_process,extenflag1,ex_num,cha,cha2) = matchlist1(imf_list[3],3,emd_data)
        elif i==2:
            (imf_process,extenflag1,ex_num,cha,cha2) = matchlist2(imf_list[3],3,emd_data)
        else:
            (imf_process,extenflag1,ex_num,cha,cha2) = matchlist3(imf_list[3],3,emd_data)
